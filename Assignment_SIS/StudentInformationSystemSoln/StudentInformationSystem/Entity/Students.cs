...
namespace StudentInformationSystem.Entity
{
    public class Students
    {
        ...
        public void EnrollInCourse(string c)
        {

            Enrollments e= new Enrollments();
            e.Course=new Courses();
            e.Course.courseName=c;
           Enrollments.Add(e);
        }
        ...
        public void UpdateStudentInfo(string firstName, string lastName, DateOnly dateOfBirth, string email, string phoneNumber)
        {
        ...
        {
            Console.WriteLine($"Student ID: {studentId}, Name: {firstName} {lastName}, DOB: {dateOfBirth.ToShortDateString()}, Email: {email}, Phone: {phone}");
        }
