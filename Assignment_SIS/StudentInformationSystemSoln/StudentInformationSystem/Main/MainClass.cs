...
namespace StudentInformationSystem.Main
{
    public class MainClass
    {
        ...
        public static void Task3()
        {
            ...
            // 4. Add Enrollments
            Enrollments e1 = new Enrollments(1, 1, 1, new DateOnly(2024, 1, 10));
            Enrollments e2 = new Enrollments(2, 2, 2, new DateOnly(2024, 2, 5));
            Enrollments e3 = new Enrollments(3, 3, 3, new DateOnly(2024, 2, 10));
            Enrollments e4 = new Enrollments(4, 4, 1, new DateOnly(2024, 3, 1));
            Enrollments e5 = new Enrollments(5, 5, 4, new DateOnly(2024, 3, 15));
            ...
            // 5. Add Payments
            Payments p1 = new Payments(1, 1, 5000, new DateOnly(2024, 1, 15));
            Payments p2 = new Payments(2, 2, 4500, new DateOnly(2024, 2, 10));
            Payments p3 = new Payments(3, 3, 4000, new DateOnly(2024, 2, 20));
            Payments p4 = new Payments(4, 4, 4800, new DateOnly(2024, 3, 5));
            Payments p5 = new Payments(5, 5, 5200, new DateOnly(2024, 3, 25));
            ...
            s1.UpdateStudentInfo("Johnny", "D", new DateOnly(2001, 6, 15), "johnny.d@example.com", "9876543210");
            s1.DisplayStudentInfo();
            ...
            s1.MakePayment(2000m,DateOnly.FromDateTime(DateTime.Now));
        ...
        {
            Students s6 = new Students(6, "Sony", "Black", new DateOnly(2013, 11, 5), "sony@example.com", "6000234560", 6000);
            sis.AddStudent(s6);
            try
            {
                // 1. CourseNotFoundException
                sis.GetCourseById(999);
            }
        ...
        {
            Students s1 = new Students(1, "Nancy", "Sparks", new DateOnly(2003, 1, 28), "sparks@example.com", "1234567890",90000);
            Courses c1 = new Courses(1, "M1", "Maths", "Alex");
            Courses c2 = new Courses(2, "M2", "Mathematics 101", "N/A");
            Teacher t1 = new Teacher(1, "Banu Rekha", "banu@trainer.com", "Maths");
            Students s2 = new Students(2, "Max", "tech", new DateOnly(2002, 5, 15), "max@example.com", "9156456789", 3000);
            Courses c4 = new Courses(4, "H1", "History", "Sophia White");
            //Enrollments e8 =new Enrollments(5, 1, 2, new DateOnly(2024, 3, 15));
            ...
            sis.AssignCourseToTeacher(c2, t1);

            sis.AddEnrollment(s1, c4, DateOnly.FromDateTime(DateTime.Now));
            sis.AddEnrollment(s2, c1, DateOnly.FromDateTime(DateTime.Now));

            sis.AddPayments(s1, 2000.00m, DateOnly.FromDateTime(DateTime.Now));
